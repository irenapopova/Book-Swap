	...
	<Page heroImage="url(./images/page-hero0.jpg)" title="About" >
		<div className="about-root">
			...
			<div className="about-author">
				<Header as="h1" className="about-author-title">About the Author - Irena Popova</Header>
				<Item.Group>
				    <Item>
				      <Item.Image src='./images/irena_popova.jpg' size='small' shape='circular' className="about-author-picture" />
				      <Item.Content>
				        <Item.Header className="about-author-location">A web developer in Berlin, Germany</Item.Header>
				        <Item.Meta className="about-author-icon">
							...
							<Button circular as="a" color='black' icon='linkedin' href="https://www.linkedin.com/public-profile/settings?trk=d_flagship3_profile_self_view_public_profile" />
				        ...
				        <Item.Extra className="about-author-link">
				            ...
				            <a className="about-link" href="https://irenapopova.github.io/">https://https://https://irenapopova.github.io/portfolio-blog//</a>
				        </Item.Extra>
				      </Item.Content>
				    </Item>
			    </Item.Group>
